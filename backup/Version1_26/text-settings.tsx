          ...
          <div className="space-y-4">
             <div className="overflow-x-auto pb-2 -mb-2">
              <div className="flex items-center gap-2 flex-nowrap">
                  ...
                  <Select value={activeFont.value} onValueChange={handleFontChange}>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <SelectTrigger className="w-full" id={`${baseId}-font-select`} aria-label="Select Font">
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                      <Button variant="outline" size="icon" data-active={isBold} onClick={() => setIsBold(!isBold)} className="data-[active=true]:bg-primary/20 h-10 w-10 flex-shrink-0">
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                      <Button variant="outline" size="icon" data-active={isUppercase} onClick={() => setIsUppercase(!isUppercase)} className="data-[active=true]:bg-primary/20 h-10 w-10 flex-shrink-0">
